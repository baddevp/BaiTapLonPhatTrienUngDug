...
public class GuiQuanLyMauSac extends JFrame implements ActionListener, MouseListener{
	...
	private void taoMaMau() {
	        String maMau = "MAU001"; // Giá trị mặc định nếu không có dữ liệu trong bảng
	        ...
	        try {
	            ...
	            if (rs.next()) {
	                ...
	                if (lastMaChucVu != null) {
	                    int number = Integer.parseInt(lastMaChucVu.substring(3));
	                    int soMoi = number + 1;
	                    String numberStr = String.format("%03d", soMoi);
	                    maMau = "MAU" + numberStr;
	                }
	            }
	        } catch (Exception e) {
