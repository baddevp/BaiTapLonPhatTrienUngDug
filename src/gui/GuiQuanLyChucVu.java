...
public class GuiQuanLyChucVu extends JFrame implements ActionListener, MouseListener, ListSelectionListener {
	...
	public void timKiemTheoMaCV(String tuKhoa) {
		TableRowSorter<DefaultTableModel> sorter = new TableRowSorter<>(modelCV);
		tblCV.setRowSorter(sorter);
