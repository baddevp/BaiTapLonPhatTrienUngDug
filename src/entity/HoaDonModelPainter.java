...
public class HoaDonModelPainter extends JPanel implements ListCellRenderer<HoaDon> {
...
//		soLuong.setBounds(1115, 165, 725, 35);//165
	...
	@Override
	public Component getListCellRendererComponent(JList<? extends HoaDon> list, HoaDon value, int index,
			boolean isSelected, boolean cellHasFocus) {
		// TODO Auto-generated method stub
		maSach.setText("Mã hóa đơn :                         " + value.getMaHoaDon());
		tenSach.setText("Nhân viên :                            " + value.getNhanVien().getTenNV());
		tacGia.setText("Khách hàng :                         " + value.getKhachHang().getTenKH());
		loaiSach.setText("Trạng thái :                            " + strTrangThai(value));

		soLuong.setText("Tiền nhận :                          " + df.format(value.getTienNhan()));
		giaBan.setText("Tổng tiền :                           " + df.format(value.getTongTien()));

		ngayNhap.setText("Ngày lập :                           " + dtf.format(value.getNgayLapHoaDon().toLocalDate()));
		if (isSelected) {
	...
	private String strTrangThai(HoaDon s) {
		// TODO Auto-generated method stub
