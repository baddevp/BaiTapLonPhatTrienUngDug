...
public class SachModelPainter extends JPanel implements javax.swing.ListCellRenderer<Sach> {
...
//		nhaSX.setBounds(1115, 15, 725, 35);
	...
	@Override
	public Component getListCellRendererComponent(JList<? extends Sach> list, Sach value, int index, boolean isSelected,
			boolean cellHasFocus) {
		 	maSach.setText  ("Mã sách :                         " +  value.getMaSanPham());
	        tenSach.setText ("Tên sách :                        " +  value.getTenSanPham());
	        tacGia.setText  ("Tác giả :                           " + value.getTacGia());
	        ...
	        loaiSach.setText("Loại sách :                       " + value.getLoaiSach().getTenLoai());
	...
	private String strTrangThai(Sach s) {
		// TODO Auto-generated method stub
		if(s.isTrangThai() == true)
			return "Còn bán";
		else if(s.getSoLuong() < 10) {
			soLuong.setForeground(Color.red);
			return "Sắp hết hàng";	
		}else {
			return "Ngưng bán";
		}
